const CONFIG = {
  ...
  services: [
    {
      ...
      currency: "PHP",
      description:
        "Free 30-minute intro call to talk about your project needs.",
    },
    {
      ...
      currency: "PHP",
      description:
        "Full setup of an AI chatbot for your business website. Handles FAQs, inquiries, and bookings. Supports English and Tagalog.",
    },
    {
      name: "Website Build",
      duration: 60,
      ...
      currency: "PHP",
      description:
        "Clean, fast static website. Portfolio, landing page, or small business site.",
    },
    {
      ...
      currency: "PHP",
      description:
        "AI-powered bot for your Facebook Page or WhatsApp Business. Responds to customers automatically 24/7.",
    },
    {
      ...
      currency: "PHP",
      description:
        "1-hour paid consultation for technical questions, project planning, or code review.",
    },
  ],
  ...
  botName: "Aria",
  botIntro:
    "Hi! I'm Aria, Oswi's AI assistant 👋 I can tell you about his services, check when he's free, or help you book a call. How can I help?",
  quickReplies: [
  ...
  /* ─────────────────────────────────────────
     GEMINI API KEY
     Paste your free key from aistudio.google.com
     Leave empty — visitors will be prompted,
     OR paste your own key here for production.
  ───────────────────────────────────────── */
  geminiKey: "",
};
